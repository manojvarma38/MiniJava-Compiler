...
public class Collector extends GJDepthFirst<Void, Void> {
    ...
    public Void visit(MainClass n, Void argu) {
        ...
        prog_info.addMethod(class_name, "main", "void", null);
        cur_method = "main";
    ...
    public Void visit(VarDeclaration n, Void argu) {
        ...
        } else if (cur_class != null && cur_method != null) {
            String var_name = n.f1.f0.toString();
            String type = getType(n.f0);
            prog_info.getMethodInfo(cur_class, cur_method).locals.put(var_name, type);
        }
        n.f2.accept(this, argu);
        return _ret;
    }
    ...
    public Void visit(MethodDeclaration n, Void argu) {
        ...
        // pass the whole node
        prog_info.addMethod(cur_class, method_name, type, n);
        n.f3.accept(this, argu);
        n.f4.accept(this, argu);
        n.f5.accept(this, argu);
        n.f6.accept(this, argu);
